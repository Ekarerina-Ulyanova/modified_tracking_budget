# Contributing to modified_tracking_budget

We welcome you to [check the existing issues](https://github.com/Ekarerina-Ulyanova/modified_tracking_budget/issues) for bugs or enhancements to work on.
If you have an idea for an extension to modified_tracking_budget, please [file a new issue](https://github.com/Ekarerina-Ulyanova/modified_tracking_budget/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/Ekarerina-Ulyanova/modified_tracking_budget/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/modified_tracking_budget.git
   ```
...
Finally, go to the web page of your fork of the modified_tracking_budget repo, and click
...
If your contribution changes modified_tracking_budget in any way:

- Update the [README](https://github.com/Ekarerina-Ulyanova/modified_tracking_budget/tree/main/README.md) if anything there has changed.
