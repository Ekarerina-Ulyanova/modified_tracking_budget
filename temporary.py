...
def stable_noise_func(alpha: float, beta: float, size: int = 1) -> np.ndarray:
    """
    Generates a stable noise function with the given parameters.

    Args:
        alpha: The parameter for the noise function, must be in the range (0, 2].
        beta: The parameter for the noise function, must be in the range [-1, 1].
        size: The size of the output array, defaults to 1.
